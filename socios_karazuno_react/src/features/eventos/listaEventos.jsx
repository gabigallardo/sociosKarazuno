        ...
        <tbody className="divide-y divide-gray-200">
          {eventos.map((evento) => (
            <tr key={evento.id} className="hover:bg-gray-50">
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 capitalize">{evento.tipo}</td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{evento.costo > 0 ? `$${parseFloat(evento.costo).toFixed(2)}` : "Gratis"}</td>
