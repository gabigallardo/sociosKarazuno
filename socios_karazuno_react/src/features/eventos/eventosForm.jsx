  ...
  const stepsConfig = [
    ...
    },
    {
      ...
      {
    // Nuevo paso para métodos de pago
    id: "metodos_pago",
    label: "¿Cómo se puede abonar la cuota?",
    type: "textarea",
    icon: FaMoneyBillWave,
    placeholder: "Ej: Transferencia Bancaria (CBU: XXXX), Efectivo al profesor.",
    condition: (formData) => formData.requisito_pago,
    validation: (value, formData) => {
      if (formData.requisito_pago && !value) {
        return "Si el evento requiere pago, debes especificar al menos un método.";
      }
      return null;
    },
  },
