...
class EventoSerializer(serializers.ModelSerializer):
    ...
    pago_inscripcion_a = UsuarioSerializer(read_only=True, allow_null=True) 
    pago_transporte_a = UsuarioSerializer(read_only=True, allow_null=True)
    pago_hospedaje_a = UsuarioSerializer(read_only=True, allow_null=True)
    pago_comida_a = UsuarioSerializer(read_only=True, allow_null=True)
    ...
    profesores_a_cargo_ids = serializers.PrimaryKeyRelatedField(
        queryset=Usuario.objects.filter(roles__nombre='profesor'), 
